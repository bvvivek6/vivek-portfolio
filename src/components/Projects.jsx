        ...
        <div className="max-h-[52vh] md:max-h-[60vh]  overflow-y-auto w-full rounded-2xl">
          {projects.map((project, idx) => (
            <div
              ...
              className="flex flex-col md:flex-row w-full mb-4 backdrop-blur rounded-2xl border border-gray-300"
            >
              {project.image && (
                <div className="w-full h-42 md:h-full rounded-2xl overflow-hidden bg-gray-100">
                  <img
                    src={project.image}
                    alt={project.title}
