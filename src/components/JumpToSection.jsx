...
const JumpToSection = ({ onJump }) => {
  ...
  return (
    <div className="fixed top-6 left-6 z-50 flex items-center h-10 bg-white/10 shadow-inner backdrop-blur-lg border text-black border-gray-200 rounded-full overflow-visible cursor-pointer ">
      <button
      ...
      {open && (
        <motion.div
          className="absolute top-14 left-0 grid grid-cols-2 min-w-[220px] gap-1
          flex-col"
